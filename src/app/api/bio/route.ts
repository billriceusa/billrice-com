...
const bioData = {
  ...
  careerHighlights: [
    ...
    { year: '2004-2005', role: 'COO of Rock Bank project (led the OTS charter effort; Dan Gilbert turned it down), then VP National Home Equity — built EquityOnline', org: 'Quicken Loans' },

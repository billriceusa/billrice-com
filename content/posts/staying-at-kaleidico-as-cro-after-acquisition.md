---
title: "Why I Stayed at Kaleidico as CRO After the Acquisition"
...
- **Business development.** New client acquisition, strategic partnerships, vertical expansion. The senior sales conversations that require knowing how this industry actually works.
- **Sales strategy and execution.** How the firm sells, what it prices, how it packages services, how the pipeline is structured. This is where I've accumulated the most institutional knowledge, and it's where I still enjoy being operational.
- **Marketing strategy and execution.** Our own demand generation, positioning, thought leadership, category ownership. The agency is in the business of selling demand generation — the way our own marketing program performs is both a revenue driver and a live proof-of-concept for what we promise clients.
...
I work with fintech founders on strategic questions like this through [Bill Rice Strategy Group](https://billricestrategy.com/). If you're approaching your own acquisition conversation and want someone who has been through the continuity version of the deal, [reach out](https://billricestrategy.com/).
